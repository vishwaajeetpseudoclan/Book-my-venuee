...
const vendors = [
  ...
  { name: "Caterers", href: "/Vendors/category/caterer" },
...
const venues = [
  ...
  { name: "Banquet Halls", href: "/venues/category/banquet-halls" },
  { name: "resorts", href: "/venues/category/resorts" },
  { name: "Gardens", href: "/venues/category/gardens" },
];
