...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-pink-50 overflow-hidden">
      ...
      >
        <h2 className="text-3xl font-extrabold text-center mb-6 text-gray-800">Login to BookMyVenue</h2>
        ...
        <div className="space-y-3">
          ...
          <SocialButton icon="/Images/call.png" text="Continue with Phone Number" />
        </div>
      </form>
